...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="hero-area text-center pb-3">
                        <span class="wow fadeInUp h2 text-dark" data-wow-delay="0.3s">Data Dosen Berdasarkan Pendidikan Terakhir {{ $status }}</span>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var apiUrl = 'http://127.0.0.1:8000/api/visualisasi/dosen/J2:N12';
            $.ajax({
                url: apiUrl,
                method: 'GET',
                dataType: 'json',
