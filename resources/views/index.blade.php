      ...
      <div class="row">
        <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12">
          <div class="contents move-effect ">
            <h2 class="head-title wow fadeInRight" ata-wow-delay="0.3s">Selamat Datang di Website Pusat Data Akreditasi
            </h2>
            <p class=" wow fadeInRight" ata-wow-delay="0.3s">Pusat Data Bukti Pendukung Akreditasi Fakultas Teknik
              Universitas Islam Makassar</p>
            <div class="header-button wow fadeInRight" ata-wow-delay="0.5s">
              <form class="d-inline" action="/daftar-dokumen" method="get">
                <div class="input-group mb-3">
                  <select class="form-select p-1 bg-success text-light shadow" name="kriteria" id=""
                    style="width: 80px;">
                    <option value="" selected>Kriteria</option>
                    @for ($i = 1; $i <= 9; $i++)
                      <option value="{{ $i }}" {{ request()->input('kriteria') == $i ? 'selected' : '' }}>
                        {{ 'Kriteria ' . $i }}</option>
                    @endfor
                    <option value="10" {{ request()->input('kriteria') == '10' ? 'selected' : '' }}>Mutu Internal
                    </option>
                    <option value="11" {{ request()->input('kriteria') == '11' ? 'selected' : '' }}>Profil Fakultas
                    </option>
                    <option value="12" {{ request()->input('kriteria') == '12' ? 'selected' : '' }}>Rencana Strategis
                    </option>
                  </select>
                  <select class="form-select p2 bg-success text-light shadow" name="tipe" id=""
                    style="width: 60px;">
                  ...
                  <input type="text" class="form-control shadow" name="result" placeholder="Cari Dokumen.."
  ...
  <section id="services" class="section-padding">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4 col-xs-12" onclick="window.location.href = '/daftar-dokumen?kriteria=10'">
          <div class="services-item wow fadeInRight border border" data-wow-delay="0.3s">
            ...
            <div class="services-content p-3 pb-3">
              <h3><a href="/daftar-dokumen?kriteria=10">Mutu</a></h3>
              <p>Internal</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4 col-xs-12" data-wow-delay="1.5s"
          onclick="window.location.href = '/daftar-dokumen?kriteria=4'">
        ...
        <div class="col-md-6 col-lg-4 col-xs-12" data-wow-delay="1.5s"
          onclick="window.location.href = '/daftar-dokumen?kriteria=5'">
        ...
        <div class="col-md-6 col-lg-4 col-xs-12" data-wow-delay="1.5s"
          onclick="window.location.href = '/daftar-dokumen?kriteria=6'">
        ...
        <div class="col-md-6 col-lg-4 col-xs-12" data-wow-delay="1.5s"
          onclick="window.location.href = '/daftar-dokumen?kriteria=7'">
        ...
        <div class="col-md-6 col-lg-4 col-xs-12" data-wow-delay="1.5s"
          onclick="window.location.href = '/daftar-dokumen?kriteria=8'">
        ...
        <div class="col-md-6 col-lg-4 col-xs-12" data-wow-delay="1.5s"
          onclick="window.location.href = '/daftar-dokumen?kriteria=9'">
        ...
        <div class="col-md-6 col-lg-4 col-xs-12" data-wow-delay="1.5s"
          onclick="window.location.href = '/daftar-dokumen?kriteria=12'">
      ...
      <div class="row align-items-center">
        <div class="col-xl-5 col-lg-6">
          <div class="section-title mb-60">
            ...
            <p class="wow fadeInUp" data-wow-delay=".4s">Fakultas Teknik Universitas Islam Makassar Memiliki Beberapa
              Layanan Aplikasi Dalam Mengelola Sistem Yang Ada Dikampus</p>
          </div>
        </div>
            ...
            <div class="pricing-active">
              <div class="single-pricing-wrapper">
                <div class="single-pricing">
                  <h4>Smart Campus</h4>
                  <h3><i class="bi bi-bank"></i></h3>
                  <p>Sistem Informasi Akademik Dosen dan Mahasiswa Fakultas Teknik</p>
                  <a href="https://simuim.uim-makassar.ac.id/siakad/" target="_blank"
                    class="button radius-30 mt-2">Kunjungi <i class="lni lni-angle-double-right"></i> </a>
                </div>
              </div>
              <div class="single-pricing-wrapper">
                <div class="single-pricing">
                  ...
                  <a href="https://ft.uim-makassar.ac.id/index.php/services/job-placement/" target="_blank"
                    class="button radius-30 mt-2">Kunjungi <i class="lni lni-angle-double-right"></i></a>
                </div>
              </div>
              <div class="single-pricing-wrapper">
                <div class="single-pricing">
                  ...
                  <a href="https://ft.uim-makassar.ac.id/index.php/services/lms-uim/" target="_blank"
                    class="button radius-30 mt-2">Kunjungi <i class="lni lni-angle-double-right"></i></a>
                </div>
              </div>
              <div class="single-pricing-wrapper">
              ...
              <div class="single-pricing-wrapper">
                <div class="single-pricing">
                  <h4>SIMPEG</h4>
                  <h3><i class="bi bi-bookmark"></i></h3>
                  <p>Sistem Informasi Jurnal Ilmiah Fakultas Teknik Universitas Islam Makassar</p>
                  <a href="https://ft.uim-makassar.ac.id/index.php/services/simpeg/" target="_blank"
                    class="button radius-30 mt-2">Kunjungi <i class="lni lni-angle-double-right"></i></a>
                </div>
              </div>
            </div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="single-service">
            ...
            <div class="content wow fadeInUp" data-wow-delay=".5s">
              ...
              <a href="https://ft.uim-makassar.ac.id/" class="button-sm radius-30 mt-2">Kunjungi <i
            ...
            <div>
              ...
              <div class="content">
                <p style="text-align: justify">
                  Puji syukur kita panjatkan ke hadirat Allah Subhanahu Wa Ta’ala, karena dengan rahmat dan karunia-Nya,
                  Fakultas Teknik Universitas Islam Makassar terus berkembang dan berinovasi dalam memberikan pelayanan
                  terbaik kepada mahasiswa, dosen, serta masyarakat.

                  Dalam era digital ini, website telah menjadi wajah institusi pendidikan yang mampu menghubungkan kita
                  dengan dunia luar secara efektif. Oleh karena itu, kami dengan bangga mempersembahkan kepada Anda
                  website resmi Fakultas Teknik UIM Al-Gazali yang telah kami perbaharui dan perkenalkan kepada seluruh
                  stakeholder kami.
                </p>
                <a href="https://ft.uim-makassar.ac.id/" class="btn btn-success mt-3">Kunjungi <i
