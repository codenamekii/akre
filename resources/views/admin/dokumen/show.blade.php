    ...
    <form action="/admin/dokumen/{{ $dokumen->id }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="row justify-content-between align-items-center p-3">
        <div class="col-lg-4 col-md-6 col-sm-12 my-2">
          ...
          <input class="form-control @error('nama') is-invalid @enderror" type="text" name="nama" id="nama" value="{{ $dokumen->nama }}" required disabled>
          @error('nama')
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 my-2">
          ...
          <select class="form-control @error('kriteria') is-invalid @enderror" name="kriteria" id="kriteria" required disabled>
            @for ($i = 1; $i <= 9; $i++)
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 my-2">
          ...
          <input class="form-control @error('sub_kriteria') is-invalid @enderror" type="text" name="sub_kriteria" id="sub_kriteria" value="{{ $dokumen->sub_kriteria }}" disabled>
          @error('sub_kriteria')
            <p class="error text-danger">{{ $message }}</p>
          @enderror
        </div>
        <div class="col-lg-4 col-md-6 col-sm-12 my-2">
          ...
          <input class="form-control @error('catatan') is-invalid @enderror" type="text" name="catatan" id="catatan" value="{{ $dokumen->catatan }}" disabled>
          @error('catatan')
            <p class="error text-danger">{{ $message }}</p>
          @enderror
        </div>
        <div class="col-lg-4 col-md-6 col-sm-12 my-2">
          ...
          <select class="form-control @error('tipe_dokumen') is-invalid @enderror" name="tipe_dokumen" id="tipe_dokumen" disabled>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 my-2" id="url-container">
          ...
          <input class="form-control @error('url') is-invalid @enderror" type="text" name="url" id="url" value="{{ $dokumen->tipe == 'URL' ? $dokumen->path : '' }}" disabled>
          @if ($dokumen->tipe == 'URL')
